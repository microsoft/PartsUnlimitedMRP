...
![Ansible Architecture Example Image](<../assets/ansiblewithazure-jan2018/ansible_arch.png>)
...
7.  Install Azure CLI 2.0 in the virtual machine you have just created and connected to, the provisioning machine `ansibleMaster`, by running the below commands in succession. It may take several minutes to update the packages running these commands
