...
### Task 1: Create two Web Server virtual machines using Azure Cloud Shell
If ou are short on time you cna just complete Tasks 1 and 2 to get a feel for it. Tasks 3, 4, 5 and 6 are primarily configuring a standalone control VM and will take approx 30 mons to complete. 
...
### Task 7: Configure Azure Credentials and SSH
