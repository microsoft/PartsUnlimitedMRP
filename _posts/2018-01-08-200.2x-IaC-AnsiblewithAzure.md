...
1. Install required software packages
    ...
    ![Screenshot of a command prompt with pip being upgraded being installed](../assets/feb2019-ansiblewithazure/ansible46.png)
    ...
    ![Screenshot of a command prompt with ansible being installed](../assets/feb2019-ansiblewithazure/ansible47.png)
...
3.  And lastly, we will create a public/private key pair, and install the public key in the local machine, to test the correct operation of Ansible. Press **Enter** when prompted, to accept the default values for the file in which to save the key, and to leave the passphrase (password) empty.
