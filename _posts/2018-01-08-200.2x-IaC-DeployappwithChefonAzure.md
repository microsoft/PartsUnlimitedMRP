...
7. Open a browser and go to the public DNS name i.e. to https://_dnsaddress_.
    (Make sure you're going to *http`s`*, and **not** *http*). You will be prompted about an invalid certificate, it is safe to ignore this for the purposes of this lab. Your prompts and steps to access the page may be different depending on your browser. The below screenshot is using *Edge*.
