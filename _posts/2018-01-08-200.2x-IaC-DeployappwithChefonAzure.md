...
8. You are taken to a page where you can download the **Starter Kit**. It is a file named **starter-kit.zip** which contains some pre-configured files to get us going quickly, and should be downloaded to a local folder i.e. **C:\Chef**. Click **Download Starter Kit** to download the zip file.
