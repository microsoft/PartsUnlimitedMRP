...
**12.** Select the third Gradle task and **click the pencil icon** and in the **Display name** box enter the the task *Clients* and set the **Gradle Wrapper** to the following location:

	src/Clients/gradlew

![](<../assets/msci-jan2018/build_gradle_clients.png>)

**12.** Set the **Working Directory** to the location **src/Clients** and then **uncheck** the checkbox in **JUnit Test Results** to Publish to TFS/Team Services since we will not be running automated tests in Clients. 
