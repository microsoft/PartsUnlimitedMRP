...
- <a href="https://docs.microsoft.com/en-us/vsts/load-test/reference-qa#links-to-useful-resources" target="_blank"><span style="color: #0066cc;" color="#0066cc">FAQs for Load Testing </span></a>
