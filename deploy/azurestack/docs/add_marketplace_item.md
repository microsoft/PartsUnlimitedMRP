...
1. On MAS-CON01, connect to your Azure Stack via PowerShell. If you're not still connected from the earlier steps, refer to the [Connect to Azure Stack](/connect_to_azurestack.md) docs from earlier.
