...
**Step 1.** Use knife to boostrap the vm: 
	...
	knife azurerm server create --azure-resource-group-name shad-chef --azure-vm-name shad-mrp `
	--azure-service-location 'westus' --azure-image-os-type ubuntu --azure-image-reference-sku '16.04.0-LTS' `
	--ssh-user shad --ssh-password W@terfr0nt --azure-vm-size Small `
	--tcp-endpoints '22,9080' -r "recipe[mrpapp::default]" -c ~/.chef/knife.rb
