...
- Have a Jenkins Master running.

    You can follow this lab to create and deploy your Jenkins instance in Azure [https://microsoft.github.io/PartsUnlimitedMRP/fundoth/fund-11-Oth-CI.htm](https://microsoft.github.io/PartsUnlimitedMRP/fundoth/fund-11-Oth-CI.htm)
...
```
http://jenkins:Passw0rd@ip_address_of_your_jenkinsmaster:8080/job/PartsUnlimitedMRP/build
```
...
**9.** Untick the box "Prevent Cross Site Request Forgery exploits" and click **Save** 
...
### Task 2: Configure Jenkins global tools 
