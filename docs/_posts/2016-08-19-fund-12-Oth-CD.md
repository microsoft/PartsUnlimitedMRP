...
**NOTE:** write down the FQDN of your newly deployed virtual machine. You can get it via the same steps that in this lab [Set up Parts Unlimited MRP with Jenkins](./fund-10-Oth-prereq.html). 
