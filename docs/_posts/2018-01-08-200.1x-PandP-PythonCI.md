...
### Task 3: Define the continuous build and test in our .travis.yml file.
...
Task 3: Create a **Github** repository for this application and link it to our **Travis CI** account.
