...
This hands-on lab was designed to show you how one of the options and scenarios of how Chef can be integrated in Azure and how run lists, nodes, cookbooks, roles and recipes can be created and deployed on Azure.
