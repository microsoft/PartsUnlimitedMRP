...
In this hands-on lab you explored some of the features and capabilities of Deploying the PU MRP App via Chef Automate server in Azure. We completed the following tasks. 
