...
1. Cd into the cookbook file then use the **knife** tool to generate a cookbook template. 
	...
	```
 	...
 	You may also be prompted to use the command `Chef generate cookbook mrpapp`
...
5.  Copy the full contents of the recipe from here: [https://raw.githubusercontent.com/Microsoft/PartsUnlimitedMRP/Labfiles/DevOps200.2x-InfrastructureasCode/Deploy_using_Chef/final/default.rb](https://raw.githubusercontent.com/Microsoft/PartsUnlimitedMRP/Labfiles/DevOps200.2x-InfrastructureasCode/Deploy_using_Chef/final/default.rb).
