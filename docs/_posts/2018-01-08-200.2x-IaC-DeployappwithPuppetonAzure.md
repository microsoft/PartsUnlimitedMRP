...
4. Configure the default node in the site.pp file
    ...
    **Note:** make sure you remove the comment tag **#** before the class definition, as in the screenshot and text example above.
...
2. Test the dummy file
    ...
    ![](..\assets\pumrpdeploywithpuppet-jan2018\dummytestresult.png)
