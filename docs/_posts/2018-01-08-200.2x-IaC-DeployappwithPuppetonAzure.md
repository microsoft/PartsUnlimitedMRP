...
though _puppet programs_ on the Puppet Master. The lab tasks to be performed in this lab are as follows:
...
2. Click on the **Deploy to Azure** button
    ...
    You should spend some time to review the template file and script that are been run. You can do so in the <a href="https://github.com/Microsoft/PartsUnlimitedMRP/tree/master/Labfiles/DevOps200.2x-InfrastructureasCode/Puppet" target="_blank"><span style="color: #0066cc;" color="#0066cc">Puppet Labfiles folder</span></a> 
