---
layout: page
title:  IaC with Puppet on Azure
category: IaC
order: 7
---
...
<h2><span style="color: #0000CD;">Infrastructure as Code with Puppet on Azure</span></h2>




In this hands-on lab, you will deploy a Java app, the Parts Unlimited MRP App, using Puppet from [PuppetLabs](https://puppetlabs.com/). Puppet is a configuration management system that allows you to automate provisioning and configuration of machines by describing the state of your infrastructure
