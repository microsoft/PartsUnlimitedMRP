---
layout: page
title:  Continuous Deployment with VSTS and Local Customised Agent on a Linux VM
category: CICD
order: 5
---
...
>**Note:** If you would like to trigger continuous deployments using the VSTS hosted VSTS agent instead of a local agent, see [this lab](https://github.com/Microsoft/PartsUnlimitedMRP/tree/master/docs/HOL_Continuous-Deployment).  
