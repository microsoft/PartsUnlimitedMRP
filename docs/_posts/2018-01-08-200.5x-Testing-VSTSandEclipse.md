...
<iframe width="960" height="640" src="https://www.youtube.com/embed/VMwkfjzwKJA" frameborder="0" allowfullscreen></iframe>
</div>
</div>
...
**18.** Type `gradle` in the filter box, and select "Gradle Tasks" then click **Open**.
...
![](..\assets\vstsandeclipse-jan2018\gradle_build_console.png)
