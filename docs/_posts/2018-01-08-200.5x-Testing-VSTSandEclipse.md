...
![](..\assets\vstsandeclipse-jan2018\find_buildship_plugin.png)

**3.** From the menu of Eclipse, select **Window -> Perspective -> Open Perspective -> Other...** to select the perspective that we want. 

![](..\assets\vstsandeclipse-jan2018\open_other_perspective.png)

**4.** Select **Git** and click **Open**.

![](..\assets\vstsandeclipse-jan2018\git_perspective.png)
...
![](..\assets\vstsandeclipse-jan2018\clone_repo.png)
...
![](..\assets\vstsandeclipse-jan2018\repo_uri.png)

Select any branch that you want, and click **Next**.

![](..\assets\vstsandeclipse-jan2018\select_branches.png)

On the next page, leave the defaults and click **Finish**.

![](..\assets\vstsandeclipse-jan2018\repo_clone_finish.png)
...
![](..\assets\vstsandeclipse-jan2018\local_repo.png)
...
**9.** In the Package Explorer window, **right-click on IntegrationService** and then select **Configure -> Add Gradle Nature**.

> **Note:** Allow network access when requested.
 
![](..\assets\vstsandeclipse-jan2018\integration_to_gradle.png)

Note: at this point, you should see the errors disappear from the project.

**15.** Follow **Step 12** to create a **new Java Project**.

**10.** In the New Java Project dialog name the project **OrderService**, uncheck the **Use default location**, choose the **OrderService** folder located in `src/Backend/` of the PartsUnlimitedMRP repository, and click **Finish**.

![](..\assets\vstsandeclipse-jan2018\new_order_service.png)

**11.** In the Package Explorer window, **right-click on OrderService** and then select **Configure -> Add Gradle Nature**.

**12.** Follow **Step 12** again to create a **new Java Project**.

**13.** In the New Java Project dialog name the project **Clients**, uncheck the **Use default location**, choose the **Clients** folder located in `src/` of the PartsUnlimitedMRP repository, and click **Finish**.

![](..\assets\vstsandeclipse-jan2018\new_clients.png)

**14.** In the Package Explorer window, **right-click on Clients** and then select **Configure -> Add Gradle Nature**.
...
![](..\assets\vstsandeclipse-jan2018\gradle_projects.png)

**15.** In Eclipse's menu select **Window -> Show View -> Other...**

![](..\assets\vstsandeclipse-jan2018\other_view.png)

**16.** Type `gradle` in the filter box, and select "Gradle Tasks" then click **Open**.

![](..\assets\vstsandeclipse-jan2018\show_gradle_view.png)
...
![](..\assets\vstsandeclipse-jan2018\integration_gradle_tasks.png)
...
![](..\assets\vstsandeclipse-jan2018\gradle_vstsandeclipse-jan2018\console.png)
...
![](..\assets\vstsandeclipse-jan2018\open_catalog_tests.png)

**2.** Lets go ahead and run these tests. In the menu select **Run -> Run As -> JUnit Test**.

![](..\assets\vstsandeclipse-jan2018\run_default_tests.png)

This should open up the JUnit window and give you a summary of the test run.

![](..\assets\vstsandeclipse-jan2018\default_test_run.png)
...
![](..\assets\vstsandeclipse-jan2018\commit_and_push.png)

The Push Results window should pop up after you have successfully pushed:

![](..\assets\vstsandeclipse-jan2018\push_results.png)
...
![](..\assets\vstsandeclipse-jan2018\build_test_summary.png)
...
![](..\assets\vstsandeclipse-jan2018\build_test_results.png)
