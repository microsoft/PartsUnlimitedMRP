...
This lab is used in course [DevOps 200.2: Infrastructure as Code: Module 4](https://courses.edx.org/courses/course-v1:Microsoft+DEVOPS200.2x+1T2018a/courseware/fbfe950d-1c5f-d34f-cba8-63fab269cc73/f7d0c312-5ea1-2989-9a31-16d1bd398fc4/2?activate_block_id=block-v1%3AMicrosoft%2BDEVOPS200.2x%2B1T2018a%2Btype%40vertical%2Bblock%40d2a81748-a576-c28a-6fca-fd70d3457dcc)
...
To allow Saltstack manage Azure resources, we need to upload the .cer file to the Azure subscription manager. Find this in the list of all services then click on your subscription id and choose to upload a new certificate:
...
In this practice lab, we have seen how using Salt with Azure simplifies an automate provisioning VMs. Other improvements could be added to what we created like security, user management, and configuration management but since our system is scalable, adding new features does not require starting another one from scratch.
